...
import com.hrms.hr.service.BadRequestException; // Assuming defined elsewhere or locally
...
public class HRDocumentController {
    ...
    public ResponseEntity<DocumentListItemDTO> uploadCompanyDocument(
            @Valid @RequestPart("metadata") HRDocumentUploadRequest metadataRequest,
        ...
        } catch (BadRequestException | IllegalStateException ex) { // For bad inputs or state issues
